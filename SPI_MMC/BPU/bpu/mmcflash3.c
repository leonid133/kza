...
xdata unsigned int i_CMD = 0x00, MMC_CMD = 0xff;
xdata unsigned long timeFlashOver = 0, address = 0x00000A00;

xdata unsigned char BufferInKZA[512], flash = 0;
sbit CS = P3^2;
...
{
	static xdata unsigned char i_RST = 0x00;
	xdata unsigned char a_tmp, b;
