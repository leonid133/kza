...
//
// Option 1:
// 1) Load the F540_Flash_test.c, F540_FlashPrimitives.c, and F540_FlashUtils.c
//    files in the Silicon Labs IDE.
// 2) Compile and download code to Side A on the C8051F540-TB
// 3) Verify the LED pin of J16 are populated on the 'F540 TB.
// 4) Run the code
...
#include <C8051F540_defs.h>            // SFR declarations
