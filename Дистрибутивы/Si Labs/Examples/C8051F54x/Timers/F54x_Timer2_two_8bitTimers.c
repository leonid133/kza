...
// How To Test:
//
// 1) Open the F540_Timer2_two_8bitTimers.c file in the Silicon Labs IDE.
// 2) If necessary change the number of interrupts to toggle an output:
//    LED_TOGGLE_RATE
//    SIGNAL_TOGGLE_RATE
// 3) Compile and download the code.
// 4) Verify the LED pins of J19 are populated on the 'F540 TB.
...
#include <C8051F540_defs.h>            // SFR declaration
...
SBIT (LED, P1, 3);                     // LED==0 means ON
SBIT (SIGNAL, P1, 5);                  // SIGNAL to be used also by Timer2
