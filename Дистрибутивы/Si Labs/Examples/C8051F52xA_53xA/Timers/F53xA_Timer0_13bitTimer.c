...
// follow these steps:
//
// 1) Open the F53xA_Timer0_13bitTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE
// 3) Compile and download the code to a 'F53xA device (either device A or
//    device B on the target board).
