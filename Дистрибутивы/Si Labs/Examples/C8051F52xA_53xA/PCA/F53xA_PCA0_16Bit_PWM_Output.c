...
// How To Test:
//
// 1) Download code to a 'F53xA device (either device A or device B on the
//    target board) which has an oscilloscope monitoring P0.0.
...
//
//
// Target:         C8051F52x/F53xA (C8051F530A TB)
