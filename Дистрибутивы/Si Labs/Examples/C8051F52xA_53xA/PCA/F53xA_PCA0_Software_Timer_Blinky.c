...
// How To Test:
//
// 1) Download code to a 'F53x (either device A or device B on the target
//    board).
// 2) Ensure the LED jumper is populated (HDR4 for device A or HDR3 for device
//    B).
// 3) Run the program - the LED should blink at 5 Hz.
//
