...
// How To Test:
//
// 1) Compile and download code to either the A device or the B device on the
//    'F53xA target board.
// 2) On the target board, connect P0.0 to P1.4 and P0.1 to P1.3.
// 3) Verify HDR4 for device A and HDR3 for device B have the LED and Switch
//    jumpers populated.
...
//
//
// Target:         C8051F52xA/F53xA (C8051F53xA TB)
...
SBIT (SWITCH, SFR_P1, 4);              // Push-button switch on board
