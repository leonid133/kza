...
// Program Description:
//
// This program configures a C8051F53xA as a 4-wire SPI Single Master.
//
...
// How To Test:
//
// 1) Download the code to a F530A-TB (either device A or device B) that is
//    connected as above to another device running the SPI0_Slave code.
// 2) Verify the LED pin jumpers are populated (HDR4 for device A and HDR3 for
//    device B).
// 3) Run the code.
