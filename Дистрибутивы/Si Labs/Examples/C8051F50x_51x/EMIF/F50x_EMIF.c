...
// How To Test:
//
// 1) Connect the C8051F500-TB to an AB1 expansion board.  The AB1 expansion
//    board includes a 128K SRAM.
// 2) On the C8051F500-TB, remove the jumper on the J20 header to 
//    disconnect the potentiometer from the port pin used for RAM CS
// 3) Download code to the side 'A' MCU on a C8051F500-TB
...
SBIT (RAM_BANK, SFR_P1, 5);            // Bank select bit is P1^5
