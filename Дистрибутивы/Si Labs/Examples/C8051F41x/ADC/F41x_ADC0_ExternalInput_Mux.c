...
// How To Test:
//
// 1) Download code to a 'F41x device that is connected to a UART transceiver
// 2) Verify the TX and RX jumpers are populated on J27.
...
sfr16 ADC0 = 0xBD;                     // 12-bit ADC0 result
...
unsigned char idata PIN_TABLE[ANALOG_INPUTS] = {0,1,3,4,5,6};
unsigned char idata PIN_MUX_TABLE[ANALOG_INPUTS] = {8,9,11,12,13,14};
