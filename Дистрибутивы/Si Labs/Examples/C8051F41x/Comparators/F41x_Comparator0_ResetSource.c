...
// 2) On the target board, connect P0.0 to P1.4 and P0.1 to P2.1
// 3) Verify that the LED is on
// 4) Press the P1.4 switch (this causes a comparator reset)
...
sbit SWITCH = P1^4;                    // Push-button switch on board
