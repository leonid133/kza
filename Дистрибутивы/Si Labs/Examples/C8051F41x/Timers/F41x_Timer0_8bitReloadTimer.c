...
// How To Test:
//
// 1) Load the F41x_Timer0_8bitReloadTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download code to a 'F41x device
// 4) Verify the LED pins of J5 are populated on the 'F41x TB.
// 5) Run the code
