...
//    CapTouchSense Daughter Card.
// 3) Run the ToolStick Terminal application on the PC.
// 4) Set up the baud rate of the ToolStick Terminal to match the baud rate of
//    the MCU. This setting is under the "ToolStick > Settings" menu.
// 5) Connect to the ToolStick using the "Connect" button.
