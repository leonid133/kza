...
// How To Test:
//
// 1) Download code to the 'F9xx toolstick
// 2) Disconnect from the 'F9xx toolstick in the IDE
// 3) Open the toolstick terminal, select the right toolstick under
//    'Connection' and then click connect. (Make sure the configured baudrate
//    matches the global constant BAUDRATE)
// 4) Each time SW2 (P0.2) is pressed, the current time will be output to
//    the terminal screen
//
//
// Target:         C8051F93x-C8051F92x
// Tool chain:     Keil C51 version 8.00 4K Compiler
//                 SDCC version 2.8.0
// Command Line:   None
//
// Release 1.2
