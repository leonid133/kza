...
// How To Test:
//
// 1) Open the F93x_Timer0_13bitExtTimer.c file in the Silicon Labs IDE
// 2) To change the number of input pulses/interrupt, modify
//    PULSES_PER_TOGGLE
// 3) To change the speed of the SIGNAL waveform, modify
//    SOFTWARE_DELAY
// 4) Compile the project
// 5) Download code to a 'F336 device
// 6) Verify the LED and switch pins of J3 are populated on the 'F336 TB.
