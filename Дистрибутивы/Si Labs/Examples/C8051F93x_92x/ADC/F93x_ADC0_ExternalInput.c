...
// How To Test:
// ------------
// 1) Download code to a 'F93x device on a C8051F93x-TB development board
// 2) Ensure that jumpers are placed on J12 of the C8051F930 target board
...
INTERRUPT (ADC_ISR, INTERRUPT_ADC0_EOC)
{
   ...
   if(measurements == 0)
   {
      ...
      mV =  result * 3360 / 1023;
      printf("\f\nP1.4 voltage: %d mV", (unsigned int) mV);
   }
}
