...
// How To Test:
//
// 1) Ensure that jumpers are placed on J12 of the C8051F912 target board
...
// 5) Download and execute code on an 'F912 target board.
// 6) Touch the "Touch Sense Switches" connected to P1.0 and P1.1 and see
