...
extern void FLASH_Write (FLADDR dest, S8 *src, U16 numbytes, bit SFLE);
extern char * FLASH_Read (S8 *dest, FLADDR src, U16 numbytes, bit SFLE);
extern void FLASH_Clear (FLADDR addr, U16 numbytes, bit SFLE);

// FLASH update/copy routines
extern void FLASH_Update (FLADDR dest, S8 *src, U16 numbytes, bit SFLE);
