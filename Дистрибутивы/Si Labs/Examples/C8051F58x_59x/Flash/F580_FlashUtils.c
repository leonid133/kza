...
void FLASH_Write (FLADDR dest, S8 *src, U16 numbytes, bit SFLE);
char * FLASH_Read (S8 *dest, FLADDR src, U16 numbytes, bit SFLE);
void FLASH_Clear (FLADDR addr, U16 numbytes, bit SFLE);

// FLASH update/copy routines
void FLASH_Update (FLADDR dest, S8 *src, U16 numbytes, bit SFLE);
...
//
//-----------------------------------------------------------------------------
S8 * FLASH_Read (S8 *dest, FLADDR src, U16 numbytes, bit SFLE)
{
   U32 i;
